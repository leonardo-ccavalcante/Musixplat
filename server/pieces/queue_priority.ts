...
export function queuePriority(
  ...
  if (typeof signal.spike === "boolean") {
    return { prioridad_cola: signal.spike ? "HIGH" : "NORMAL" };
  }
  ...
  if (umbralNum !== null && intensidadNum !== null) {
    return { prioridad_cola: intensidadNum >= umbralNum ? "HIGH" : "NORMAL" };
  }
