...
-- proponente <> operador; (6) the circular FKs + Conversa_Episodio extension exist.
begin;
select plan(12);
...
insert into catalog."Cohort_Rule_Version"(version_id, fecha, que_cambio) values ('vtest', date '2026-06-17', 't');
insert into cohort."Cohort"(cohort_id, tenure_bucket, tier_base, cohort_rule_version)
  values ('cohort_test', '6-12m', 'long_tail', 'vtest');
insert into gov."Usuario"(usuario_id, tenant_id, nivel_org) values
  ('U-PROP', 'POOL-T', 'equipo'), ('U-CONF', 'POOL-T', 'equipo');
insert into gov."Politica_Tier"(policy_id, policy_version, teto_tier) values ('P-test', 'pv-test', 'MEDIA');
