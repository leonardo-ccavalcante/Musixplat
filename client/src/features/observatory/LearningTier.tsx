...
// Vetting state is `reviewed` (there is NO human_authored/verification_status column). Approve/reject
// reuses the EXISTING AutonomyControls review queue — no new approve code, no recomputation.
